...
class ValidatorASN(ConfigParserValidator):
    ...
    def _validate(self, v):
        try:
            ...
            raise ValidationError("Invalid ASN: {}".format(v))
...
class ValidatorIPAddr(ConfigParserValidator):
    ...
    def _validate(self, v):
        try:
            ...
            raise ValidationError("Invalid IP address: {}".format(v))
...
class ValidatorIPv4Addr(ConfigParserValidator):
    ...
    def _validate(self, v):
        try:
            ...
            raise ValidationError("Invalid IPv4 address: {}".format(v))
...
class ValidatorIPv6Addr(ConfigParserValidator):
    ...
    def _validate(self, v):
        try:
            ...
            raise ValidationError("Invalid IPv6 address: {}".format(v))
...
class ValidatorListOf(ConfigParserValidator):
    ...
    def _validate(self, l):
        if not isinstance(l, list):
            raise ValidationError("Invalid format: must be a list")
...
class ValidatorPrefixListEntry(ConfigParserValidator):
    ...
    def _validate(self, v):
        if not isinstance(v, dict):
            raise ValidationError("Invalid prefix list entry format: must be dict")
        ...
        try:
            ...
            raise ValidationError("Invalid prefix ID: {}".format(v["prefix"]))
        ...
        try:
            ...
            raise ValidationError("Invalid prefix length: {}".format(v["length"]))
...
class ValidatorBool(ConfigParserValidator):
    ...
    def _validate(self, v):
        try:
            ...
            raise ValidationError("Invalid boolean value: {}".format(v))
            ...
            for part_idx in range(len(parts)):
                ...
                if needed:
                    ...
                    if part_idx != len(parts) - 1:
                        ...
                        raise ValidationError("'{}' macro can be used only "
                                              "in the last part of the value".format(macro_name))
                else:
                    raise ValidationError("'{}' macro not allowed".format(macro_name))
            if needed and not macro_found:
                raise ValidationError("'{}' macro is mandatory in this "
